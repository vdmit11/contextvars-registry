...
from contextvars_extras.args import make_arg_getter, make_arg_getter_for_context_var
...
make_arg_getter.register(ContextVarDescriptor, make_arg_getter_for_context_var)
